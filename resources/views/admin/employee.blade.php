...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title text-left text-light">Employees</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-secondary">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-secondary">Employees</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-secondary">Employees List</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" style="background: #4F1C51">
                                                <table id="datatable-buttons" class="table text-white table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
